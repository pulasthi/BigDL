...
import com.intel.analytics.bigdl.models.autoencoder.TrainLargeFloat.genData
...
object toMnistBatchDataGen {
  def apply(): toMnistBatchDataGen[Float] = new toMnistBatchDataGen[Float]()
}

class toMnistBatchDataGen[T: ClassTag](implicit ev: TensorNumeric[T]
...
//      val testDataPath = Paths.get(param.folder, "/mnist_test_small.csv")
      ...
      val trainDataSet = DataSet.array(genData(param.dataSize, param.inputSize + 1), sc) ->
